...
rem 1. build client.sln, Lobby.sln, DashFireServer.sln
...
rem echo gem StrDictionary
rem %i18n_tool%
rem xcopy %i18ndir%\%lang%\StrDictionary.txt %resdir%\Public\ /Y

rem echo update resource files
rem %rescopy% %resdir% %svrbin%\data isserver
rem %rescopy% %resdir% %clires%
